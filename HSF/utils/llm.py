...
class FastChatLLM:
    ...
    def __call__(self, prompt):
        ...
        output_ids = self.model.generate(
            ...
            do_sample=True,
            temperature=0.7,  # Increased from 0.3 to 0.7 for more diversity
            max_new_tokens=256,  # Reduced from 2048 to 256 for focused responses
            top_p=0.9,  # Added top_p for better sampling
            top_k=50,   # Added top_k for better sampling
