...
parser.add_argument("--data_ratio", type=float, default=0.7, help="Ratio of dataset to use (0.1 = 10%)")
...
parser.add_argument("--threshold", type=float, default=0.7, help="Confidence threshold for predictions")
